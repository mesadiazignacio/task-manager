...
export default function TaskCard({ task, canEdit }: TaskCardProps) {
    ...
    return (
        <li className="p-[2rem] bg-slate-300 rounded-lg border-slate-100 flex justify-between gap-[1rem]">
            <div {...listeners} {...attributes} ref={setNodeRef} style={style} className="min-w-0 flex flex-col gap-y-[1rem]">
                <p className="text-xl text-left">{task.name}</p>
